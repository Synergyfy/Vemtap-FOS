      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm p-6 lg:col-span-2">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 flex items-center gap-2">
              ...
              <InfoTooltip content="Monthly total revenue breakdown." />
            </h2>
            <button 
              onClick={() => exportToCSV(monthlyData, "monthly_revenue")}
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm p-6">
          <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 mb-6 flex items-center gap-2">
            ...
            <InfoTooltip content="See which subscription tiers and services contribute the most to your bottom line." />
          </h2>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
        <div className="border-b border-zinc-200 dark:border-zinc-800 p-6 flex justify-between items-center">
          <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 flex items-center">
            Transaction History
            <InfoTooltip content="A detailed log of all transactions. You can export this to CSV." />
          </h2>
          <div className="flex items-center gap-4">
            <span className="text-sm text-zinc-500">Showing {filteredData.length} records</span>
            <button 
              onClick={() => exportToCSV(filteredData, "transactions_history")}
